# Generated by Django 3.0.9 on 2020-08-10 22:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medstore.Company')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalDetails',
            fields=[
                ...
                ('description', models.CharField(max_length=255)),
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('medicine_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medstore.Medicine')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeSalary',
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medstore.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeBank',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('bill_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medstore.Bill')),
                ('medicine_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medstore.Medicine')),
            ],
        ),
        migrations.AddField(
            model_name='bill',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medstore.Customer'),
        ),
    ]
